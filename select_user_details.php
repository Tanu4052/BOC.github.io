...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  <div class="container-fluid">
    <a class="navbar-brand" href="#">BOC Bank
         </a>
    ...
    <title>Easier Money Transfer</title>
...
<body style="background-color : #00008B ;">
	...
	<div class="container">
        <h2 class="text-center pt-4" style="color : white;">Easier Money Transfer</h2>
            <?php
                include 'config.php';
                $sid=$_GET['id'];
    ...
    <footer class="text-center mt-5 py-2">
            <p> <b>Tanu Meena</b> <br> BOC Bank</p>
    </footer>
